...
class QuizGameLevelEightFragment : Fragment() {
    ...
    private fun setListeners() {
        ...
        binding.run {
            firstButtonQuestionEight.setOnClickListener {
                showTheAnswer(rightAnswer, firstButtonQuestionEight)
                goToNextScreen(true)
                showAnswerToast(true)
            }
            secondButtonQuestionEight.setOnClickListener {
                showTheAnswer(wrongAnswer, secondButtonQuestionEight)
                showTheAnswer(rightAnswer, firstButtonQuestionEight)
                goToNextScreen(false)
                showAnswerToast(false)
            }
            thirdButtonQuestionEight.setOnClickListener {
                showTheAnswer(rightAnswer, firstButtonQuestionEight)
                showTheAnswer(wrongAnswer, thirdButtonQuestionEight)
                goToNextScreen(false)
                showAnswerToast(false)
            }
            fourthButtonQuestionEight.setOnClickListener {
                showTheAnswer(rightAnswer, firstButtonQuestionEight)
                showTheAnswer(wrongAnswer, fourthButtonQuestionEight)
                goToNextScreen(false)
                showAnswerToast(false)
            }
        }
    ...
    private fun goToNextScreen(gameStats: Boolean) {
        if (gameStats) {
            setNextScreen(R.id.quizGameWinFragment)
        } else {
    ...
    private fun wrongAnswerToast() {
        Toast.makeText(
            this@QuizGameLevelEightFragment.requireContext(),
            "Resposta incorreta!",
            Toast.LENGTH_SHORT
        ).show()
    }
