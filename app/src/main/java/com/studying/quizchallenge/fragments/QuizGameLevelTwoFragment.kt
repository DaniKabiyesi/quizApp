...
class QuizGameLevelTwoFragment : Fragment() {
    ...
    private fun setListeners() {
        ...
        binding.run {
            firstButtonQuestionTwo.setOnClickListener {
                showTheAnswer(wrongAnswer, firstButtonQuestionTwo)
                showTheAnswer(rightAnswer, thirdButtonQuestionTwo)
                goToNextScreen(false)
                showAnswerToast(false)
            }
            secondButtonQuestionTwo.setOnClickListener {
                showTheAnswer(wrongAnswer, secondButtonQuestionTwo)
                showTheAnswer(rightAnswer, thirdButtonQuestionTwo)
                goToNextScreen(false)
                showAnswerToast(false)
            }
            thirdButtonQuestionTwo.setOnClickListener {
                showTheAnswer(rightAnswer, thirdButtonQuestionTwo)
                goToNextScreen(true)
                showAnswerToast(true)
            }
            fourthButtonQuestionTwo.setOnClickListener {
                showTheAnswer(wrongAnswer, firstButtonQuestionTwo)
                showTheAnswer(rightAnswer, thirdButtonQuestionTwo)
                goToNextScreen(false)
                showAnswerToast(false)
    ...
    private fun goToNextScreen(gameStats: Boolean) {
        ...
        if (gameStats) {
            setNextScreen(R.id.quizGameLevelThreeFragment)
        } else {
    ...
    private fun wrongAnswerToast() {
        Toast.makeText(
            this@QuizGameLevelTwoFragment.requireContext(),
            "Resposta incorreta!",
            Toast.LENGTH_SHORT
        ).show()
    }
